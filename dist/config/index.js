...
exports.Config = {
    ...
    // Paths
    ASSETS_PATH: path_1.default.join(__dirname, '../../assets'),
    CONFIG_PATH: path_1.default.join(__dirname, '../../config'),
    // WebSocket
    ...
    LOG_FILE_PATH: path_1.default.join(__dirname, '../../logs/server.log'),
};
